...
public class ContribCoverageColumnInfo extends AbstractColumnInfo<Float> {
    private static final String COLUMN_NAME = "Contrib. Coverage";
    private static final String COLUMN_SIZER = COLUMN_NAME + "  ";

    public ContribCoverageColumnInfo() {
    ...
    public Float valueOf(DefaultMutableTreeNode defaultMutableTreeNode) {
        ...
        if (userObject instanceof HasCoverageInfo) {
            ...
            return coverageData.getCoverage();
        } else {
            return null;
        }
    }
