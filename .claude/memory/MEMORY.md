...
- [Eclipse p2 Update Site Migration Plan](eclipse-plugin-site.md) — OC-134: plan to migrate the Eclipse update site from legacy site.xml to a p2 repository (no Tycho), served over HTTPS
