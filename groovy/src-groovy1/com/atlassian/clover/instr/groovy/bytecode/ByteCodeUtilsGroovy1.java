...
public class ByteCodeUtilsGroovy1 {
     ...
     *
     * @see ByteCodeUtilsGroovy1#pushConstant(groovyjarjarasm.asm.MethodVisitor,int)
     * @see ByteCodeUtilsGroovy2#pushConstant(groovyjarjarasm.asm.MethodVisitor,int)
    ...
    /**
     * pushConstant(groovyjarjarasm.asm.MethodVisitor as interface, int)
     *
     * @see com.atlassian.clover.instr.groovy.bytecode.ByteCodeUtilsGroovy2#pushConstant(groovyjarjarasm.asm.MethodVisitor,int)
     * @param mv visitor of the method to be modified
     * @param value value to be pushed on stack
     */
