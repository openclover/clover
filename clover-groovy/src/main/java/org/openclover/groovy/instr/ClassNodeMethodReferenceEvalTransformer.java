...
class ClassNodeMethodReferenceEvalTransformer implements ClassNodeTransformer {

    private final Function<ClassRowColumn, Expression> newRecorderExpression;

    public ClassNodeMethodReferenceEvalTransformer(Function<ClassRowColumn, Expression> newRecorderExpression) {
