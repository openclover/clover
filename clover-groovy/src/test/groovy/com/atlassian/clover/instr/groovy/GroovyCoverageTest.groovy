 ...
 * All code samples are executed via PSVM methods.
 */
@CompileStatic
                    ...
                    assertFile p, named("FooTest.groovy"), { FullFileInfo f ->
                        assertClass(f, named("FooTest"), { FullClassInfo c ->
                            assertTestCase(c, { TestCaseInfo it -> it.qualifiedName == "FooTest.testBar1" }, { TestCaseInfo it -> it.isSuccess() }) &&
                                    assertTestCase(c, { TestCaseInfo it -> it.qualifiedName == "FooTest.testBar2" }, { TestCaseInfo it -> it.isSuccess() }) &&
                                    assertMethod(c, simplyNamed("main"), { MethodInfo m ->
                                        m.hitCount == 1 &&
                    ...
                    assertFile p, named("FooTest.groovy"), { FullFileInfo f ->
                        assertClass(f, named("FooTest"), { FullClassInfo c ->
                            assertTestCase(c, { TestCaseInfo it -> it.qualifiedName == "FooTest.testNoException" }, { TestCaseInfo it -> it.isSuccess() }) &&
                                    assertTestCase(c, { TestCaseInfo it -> it.qualifiedName == "FooTest.testExpectedException" }, { TestCaseInfo it -> it.isSuccess() }) &&
                                    assertTestCase(c, { TestCaseInfo it -> it.qualifiedName == "FooTest.testUnexpectedException" }, { TestCaseInfo it -> !it.isSuccess() })
                        })
                    }
                })
    }
