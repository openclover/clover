...
class GroovyVersions {
    static String DEFAULT_VERSION = "4.0.32"
    ...
    static Closure<List<String>> CHOOSE_LATEST_MAJOR_IF_NULL_ELSE_SPLIT = { String it ->
        it == null || it.empty ?
                ["2.0.8", "2.1.9", "2.2.2", "2.3.11", "2.4.21", "2.5.23", "3.0.19", "4.0.32", "5.0.4"] :
                it.split(",").toList()
    }
}
