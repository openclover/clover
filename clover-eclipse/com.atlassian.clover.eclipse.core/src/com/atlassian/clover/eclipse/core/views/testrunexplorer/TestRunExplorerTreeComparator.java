...
public abstract class TestRunExplorerTreeComparator extends ExplorerViewComparator {
    ...
    protected static final Double ZERO_DOUBLE = new Double(0.0);
    ...
    public static int compareStarted(Object value1, Object value2) {
        TestCaseNode testCase1 = toTestCaseNode(value1);
        TestCaseNode testCase2 = toTestCaseNode(value2);
        Long started1 = testCase1 == null ? ZERO_LONG : new Long(testCase1.getStartTime());
        Long started2 = testCase2 == null ? ZERO_LONG : new Long(testCase2.getStartTime());
    ...
    public static int compareStatus(Object value1, Object value2) {
        ...
        Integer status1 =
            testCase1 == null
                ? MAX_INTEGER
                : new Integer(testCase1.getStatus());

        Integer status2 =
            testCase2 == null
                ? MAX_INTEGER
                : new Integer(testCase2.getStatus());
    ...
    public static int compareTime(Object value1, Object value2) {
        TestCaseNode testCase1 = toTestCaseNode(value1);
        TestCaseNode testCase2 = toTestCaseNode(value2);
        Double time1 = testCase1 == null ? ZERO_DOUBLE : new Double(testCase1.getDurationInSeconds());
        Double time2 = testCase2 == null ? ZERO_DOUBLE : new Double(testCase2.getDurationInSeconds());
