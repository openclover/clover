...
[![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/openclover/clover/A-build-and-test-jdk8.yml?label=JDK8)](https://github.com/openclover/clover/actions/workflows/A-build-and-test-jdk8.yml)
