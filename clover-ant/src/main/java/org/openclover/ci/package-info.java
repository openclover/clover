 ...
 * <p>&nbsp;</p>
 * The {@link org.openclover.ci.CIOptions.Builder} should be used to create and configure a
 * {@link org.openclover.ci.CIOptions} instance that then gets passed to one of the
 * {@link org.openclover.ci.Integrator.Factory}'s "new*" methods.
 *
 * <h2>Examples</h2>
