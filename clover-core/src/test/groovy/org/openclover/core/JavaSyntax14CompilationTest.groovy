...
//        assertFileMatches(fileName, quote("case null, default -> ") + R_CASE_EXPRESSION_LEFT + quote("31;") + R_CASE_EXPRESSION_RIGHT)
    ...
    void switchIsAnExpressionInDifferentContexts() {
        ...
        assertFileMatches(fileName, quote("case 10 ->") + R_CASE_EXPRESSION_WITH_YIELD_LEFT + " 100;" + R_CASE_EXPRESSION_RIGHT)
        assertFileMatches(fileName, quote("default ->") + R_CASE_EXPRESSION_WITH_YIELD_LEFT + " 200;" + R_CASE_EXPRESSION_RIGHT)

        // part of an expression
        assertFileMatches(fileName,
                // we have '((((' because of the branch evaluation
                R_INC + quote("if ((((switch (j) {") + "\\s+" +
                quote("case 0 ->") + R_CASE_EXPRESSION_WITH_YIELD_LEFT + quote(" 30;") + R_CASE_EXPRESSION_RIGHT + "\\s+" +
                quote("default ->") + R_CASE_EXPRESSION_WITH_YIELD_LEFT + quote(" 31;") + R_CASE_EXPRESSION_RIGHT + "\\s+" +
                quote("} % 10 == 0)") +
    ...
    void switchIsAStatementInDifferentContexts() {
        ...
        assertFileMatches(fileName, R_INC + quote("switch (kk) {") + "\\s+" +
                quote("case 77 ->") + R_CASE_EXPRESSION_NO_YIELD_LEFT +
                quote(" System.out.println(\"77\");") + R_CASE_EXPRESSION_RIGHT)

        // instance initializer block
        assertFileMatches(fileName,
                R_INC + quote("switch (kkk) {") + "\\s+" +
                quote("case 88 ->") + R_CASE_EXPRESSION_NO_YIELD_LEFT + quote(" System.out.println(\"88\");") + R_CASE_EXPRESSION_RIGHT + "\\s+" +
                quote("default ->") + R_CASE_EXPRESSION_NO_YIELD_LEFT + quote(" System.out.println(\"not 88\");") + R_CASE_EXPRESSION_RIGHT)
    }
