 ...
 */
class MoneyBag implements IMoney, java.io.Serializable {
	private Vector fMonies= new Vector(5);

    static class Mint {
        public Mint() {
            throw new RuntimeException("Error message to test the linkification of stack traces: " +
                    "<instances> of <Mint> should not be created.");
        }
	...
	public IMoney addMoney(Money m) {
		return Mint.create(m, this);
	}
	public IMoney addMoneyBag(MoneyBag s) {
		return Mint.create(s, this);
	}
