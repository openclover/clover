//FROM https://svn.codehaus.org/groovy/tags/GROOVY_1_8_0/src/main/org/codehaus/groovy/antlr/groovy.g

// Note: Please don't use physical tabs.  Logical tabs for indent are width 4.
header {
package clover.org.codehaus.groovy.antlr.parser;
import clover.org.codehaus.groovy.antlr.*;
import java.util.*;
...

{
    ...
    protected GroovyRecognizer parser;  // little-used link
    private void require(boolean z, String problem, String solution) throws SemanticException {
