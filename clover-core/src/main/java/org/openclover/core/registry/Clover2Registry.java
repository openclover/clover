...
import org.openclover.core.registry.format.FileInfoRecord;
...
public class Clover2Registry implements InstrumentationTarget {
     ...
     * (e.g {@link InstrumentationSessionImpl#enterFile} etc), then a call to {@link InstrumentationSessionImpl#finishAndApply()}
     */
