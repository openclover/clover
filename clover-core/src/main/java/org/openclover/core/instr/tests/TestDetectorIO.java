...
/**
 * Helpers for writing polymorphic {@link TestDetector} / {@link TestSourceMatcher}
 * values with the tag-based format.
 * <p>
 ...
 * {@code in.read(TestDetector.class)} / {@code in.read(TestSourceMatcher.class)}.
 */
